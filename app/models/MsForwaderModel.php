...
{
    private $table_ms = "[bambi-bmi].[dbo].msForwader";
    private $table_ktg = "[bambi-bmi].[dbo].MasterKategori";
    private $table_fro = "[bambi-bmi].[dbo].FrowaderDetail";
    private $table_frofinal = "[bambi-bmi].[dbo].FrowaderDetail_Temporary";
    public function SaveData($post)
    {
        ...
        $query = "
            ...
            SET @kategori = (
                ...
                FROM [bambi-bmi].[dbo].MasterKategori 
